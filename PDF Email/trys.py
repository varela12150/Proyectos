...
import locale
import sys
from PDF_creator import generate as report
from message import generate as email_generate
from message import send as email_send
...
def main(argv):
    ...
    report('cars.pdf', "Cars report", new_summary, cars_dict_to_table(data))
    # TODO: send the PDF report as an email attachment
    msg = email_generate("automation@example.com", "<username>@example.com",
                         "Sales summary for last month", new_summary, "cars.pdf")
    email_send(msg)
